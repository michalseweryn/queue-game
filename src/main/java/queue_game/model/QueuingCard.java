...
public enum QueuingCard {
	DELIVERY_ERROR, NOT_YOUR_PLACE, LUCKY_STRIKE, MOTHER_WITH_CHILD, 
	UNDER_THE_COUNTER_GOODS, TIPPING_FRIEND, CRITISIZING_AUTHORITIES,
	INCREASED_DELIVERY, CLOSED_FOR_STOCKTAKING, COMMUNITY_LIST;
